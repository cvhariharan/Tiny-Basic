...
int getType(char *token) {
    // Keywords
    if(0 == strcmp(token, "PRINT")) return PRINT;
    else if(0 == strcmp(token, "IF")) return IF;
    else if(0 == strcmp(token, "THEN")) return THEN;
    else if(0 == strcmp(token, "GOTO")) return GOTO;
    else if(0 == strcmp(token, "INPUT")) return INPUT;
    else if(0 == strcmp(token, "LET")) return LET;
    else if(0 == strcmp(token, "GOSUB")) return GOSUB;
    else if(0 == strcmp(token, "RETURN")) return RETURN;
    else if(0 == strcmp(token, "CLEAR")) return CLEAR;
    else if(0 == strcmp(token, "LIST")) return LIST;
    else if(0 == strcmp(token, "RUN")) return RUN;
    else if(0 == strcmp(token, "END")) return END;
